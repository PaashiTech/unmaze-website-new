  ...
  [
    {
      ...
      bio: "Investment Banker, Corp Finance & Expansion Advisor, ex-Nomura",
      reverse: false,
    },
    {
      id: 2,
      image: Suman,
      name: "Suman Tiwari",
      bio: "Tech Wizard, Strategy & Operations, ex-Nomura, ex-OYO SEBI-certified RIA",
      reverse: true,
    },
  ],
  [
    {
      ...
      image: Vartika,
      name: "Vartika Goel",
      bio: "Head of Marketing, Jill of all Trades, ex-PlayShifu, ex-KTM",
      reverse: false,
    },
    {
      id: 4,
  ...
  [
    {
      ...
      image: Ketan,
      name: "Ketan Damle",
      bio: "Product Designer UX Research, Origami Artist",
      reverse: false,
    },
    {
      id: 6,
      image: Harsh,
      name: "Harsh Mohite",
      bio: "Frontend Developer, ex-Schneider Electric, Casual Speedcuber",
      reverse: true,
    },
  ],
  [
    {
      ...
      bio: "Research Intern, Data Analyst,Sports Enthusiast",
      reverse: false,
    },
    {
      id: 8,
      image: Urvik,
      name: "Urvik Jada",
      bio: "Backend Intern, Tech Analyst, ex-Deutsche Bank",
      reverse: true,
    },
  ],
];
