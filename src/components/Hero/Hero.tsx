...
const Hero = () => {
  return (
    <div
      id="home"
      className="relative my-auto flex min-h-[calc(100dvh-4.5rem)] flex-col items-center justify-center gap-12 overflow-x-clip bg-gradient-unmaze-hero px-[1.25rem] py-[6.45rem] text-center text-primary-green lg:px-[5.625rem] lg:py-[15rem]"
    >
      <BackgroundLogo />
