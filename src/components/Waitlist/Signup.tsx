  ...
  return (
    ...
    >
      <div className="mx-auto flex w-full max-w-[30rem] items-center justify-center rounded-full  border-[1px] border-solid border-primary-yellow font-font-body">
        ...
        <button
          type="submit"
          className="flex shrink-0 items-center rounded-r-full bg-gradient-unmaze-hero px-[1.5rem] py-[0.75rem] font-semibold text-primary-green lg:px-[2.25rem] lg:py-[0.88rem]"
        >
