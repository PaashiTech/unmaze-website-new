...
const Careers = () => {
  return (
    <div
      id="careers"
      className="flex scroll-m-[76px] justify-center bg-primary-green px-5 py-8 lg:scroll-m-[95.2px] lg:p-0"
    >
      <div className="lg:bg-gradient-unmaze-1 rounded-[1.25rem] bg-white px-9 py-12 text-primary-green lg:rounded-none lg:bg-transparent lg:px-[5.625rem] lg:py-16">
      ...
      <div className="hidden lg:block lg:w-full lg:overflow-hidden">
        <img
          src={officeImage}
          alt="office"
          className="h-auto w-full -translate-x-[10rem] -translate-y-[3rem] scale-[1.5] object-cover"
        />
      </div>
    </div>
  );
